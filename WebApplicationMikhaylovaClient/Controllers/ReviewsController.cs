...
namespace WebApplicationMikhaylovaClient.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_rev,user_rev,rev_cons,img_rev")] Reviews reviews)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_rev,user_rev,rev_cons,img_rev")] Reviews reviews)
        {
            if (ModelState.IsValid)
            {
